...
support_image = PhotoImage(file = r"Images/support.png")
...
# gia to support
support_button = Button(text="Balance", padx=0, pady=0,
                        fg="#413c69", activeforeground="#413c69", bg="#e1fa40", activebackground="#e1fa40", image=support_image, compound=TOP)
support_button.grid(row=2, column=4, padx=10, pady=10)
support_button.config(font=("Calibri bold", 16))
