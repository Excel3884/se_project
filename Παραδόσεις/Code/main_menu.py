...
menu.iconbitmap("budget_icon.ico")
menu.configure(background="#4a47a3")

# eikona me to logotypo
menu_image = ImageTk.PhotoImage(Image.open("menu_image.png"))
label_image = Label(image=menu_image, background="#4a47a3")
label_image.grid(row=0, column=0, columnspan=5)

#eikones gia ta buttons
sales_image = PhotoImage(file = r"sales.png")
expenses_image = PhotoImage(file = r"expenses.png")
balance_image = PhotoImage(file = r"images.png")
monthly_image = PhotoImage(file = r"img_7322.png")
report_image = PhotoImage(file = r"report.png")

#-----------------------------------koumpia menou------------------------------#
# gia tis pwlhseis
sales_button = Button(text="Sales", padx=30, pady=0,
                      fg="#413c69", activeforeground="#413c69", bg="#009813", activebackground="#009813", image=sales_image, compound=TOP)
